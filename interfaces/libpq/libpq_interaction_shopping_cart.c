...
execute_shopping_cart(struct db_context_t *dbc, struct shopping_cart_t *data)
{
	...
	res = pgsql_execute(dbc->conn, STMT_SC, data->c_id, data->sc_id,
					...
					data->pp_data.i_id,
					data->sc_refresh[0].scl_i_id, 
					data->sc_refresh[1].scl_i_id, 
					data->sc_refresh[2].scl_i_id, 
					data->sc_refresh[3].scl_i_id, 
					data->sc_refresh[4].scl_i_id, 
					data->sc_refresh[5].scl_i_id, 
					data->sc_refresh[6].scl_i_id, 
					data->sc_refresh[7].scl_i_id, 
					data->sc_refresh[8].scl_i_id, 
					data->sc_refresh[9].scl_i_id, 
					data->sc_refresh[10].scl_i_id, 
					data->sc_refresh[11].scl_i_id, 
					data->sc_refresh[12].scl_i_id, 
					data->sc_refresh[13].scl_i_id, 
					data->sc_refresh[14].scl_i_id, 
					data->sc_refresh[15].scl_i_id, 
					data->sc_refresh[16].scl_i_id, 
					data->sc_refresh[17].scl_i_id, 
					data->sc_refresh[18].scl_i_id, 
					data->sc_refresh[19].scl_i_id, 
					data->sc_refresh[0].scl_qty,
					data->sc_refresh[1].scl_qty,
					data->sc_refresh[2].scl_qty,
					data->sc_refresh[3].scl_qty,
					data->sc_refresh[4].scl_qty,
					data->sc_refresh[5].scl_qty,
					data->sc_refresh[6].scl_qty,
					data->sc_refresh[7].scl_qty,
					data->sc_refresh[8].scl_qty,
					data->sc_refresh[9].scl_qty,
					data->sc_refresh[10].scl_qty,
					data->sc_refresh[11].scl_qty,
					data->sc_refresh[12].scl_qty,
					data->sc_refresh[13].scl_qty,
					data->sc_refresh[14].scl_qty,
					data->sc_refresh[15].scl_qty,
					data->sc_refresh[16].scl_qty,
					data->sc_refresh[17].scl_qty,
					data->sc_refresh[18].scl_qty,
					data->sc_refresh[19].scl_qty
);
