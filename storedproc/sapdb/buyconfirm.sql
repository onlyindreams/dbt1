...
/*
/*/
CREATE DBPROC buyconfirm( IN cc_type varchar(10), IN cc_num fixed(16), 
...
SELECT co_id INTO :co_id FROM dbt.country WHERE co_name=:country;
SELECT addr_id INTO :ship_addr_id FROM dbt.address
