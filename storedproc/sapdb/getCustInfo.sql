...
SELECT c_id, c_passwd, c_fname, c_lname, c_phone, c_email, 
  c_data, CHAR(c_birthdate, ISO), c_discount,
  addr_street1, addr_street2, addr_city, addr_state, addr_zip, co_name
INTO :C_ID, :C_PassWD, :C_FName, :C_LName, 
  :C_Phone, :C_Email, :C_Data, :C_BirthDate, :c_discount,
  :Addr_Street1, :Addr_Street2, :Addr_City, :Addr_State, :Addr_Zip, :Co_Name
FROM dbt.CUSTOMER, dbt.address, dbt.country
WHERE c_uname = :C_UName and addr_id = c_addr_id and addr_co_id=co_id;
